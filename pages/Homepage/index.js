...
// import IntroVideo from "../../videos/1.mov";
...
import HeroRight from "./HeroRight/index";
...
export default function Index() {
    ...
    return (
        <>
        {/* {
            user.isVisited?<NewsletterModal />:""
        } */}
        <Banner />
                ...
                <div className="relative z-10 pb-8 bg-black md:pb-20 lg:w-full xl:px-20">
                            ...
                            <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                    <div className="flex items-center justify-between w-full md:w-auto">
                                        ...
                                        <Link to="/checkout" className="font-medium text-gray-600 hover:text-gray-200">Home</Link>
                                        </a>
                                ...
                                <div className="lg:absolute lg:right-0 md:block md:ml-10 md:pr-4 md:space-x-8">
                                    <Link to="/checkout" className="font-medium text-gray-600 hover:text-gray-200">Blogs</Link>
                                </div>
                            </nav>
                        </div>
                        <div className="xl:px-80">    
                            <div className="lg:absolute lg:left-0 xl:absolute xl:left-0">
                                <Link to="/checkout">
                                    <img className="xl:65 object-contain sm:h-48 md:h-96 lg:w-75 lg:h-96" style={{maxWidth:"80%", margin:"auto"}} src={HeroImage} alt="" />

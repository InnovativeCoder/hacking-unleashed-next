...
export default function Termsandconditions() {
    return (
        <div className="prose lg:prose-xl min-w-full px-5 py-20 text-justify">
            <h1 className="not-prose text-gray-200">
                TERMS OF SERVICE
            </h1>
            <h2 className="not-prose text-gray-200">
                OVERVIEW
            </h2>
            <p className="leading-5 text-gray-400 text-sm ">
                This website is operated by Hacking Unleashed, LLC (“Hacking Unleashed”, “the Company”). Throughout the site, the terms “we”, “us” and “our” refer to Hacking Unleashed. Hacking Unleashed offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                ...
                Our store is hosted on Cratejoy. They provide us with the online e-commerce platform that allows us to sell our products and services to you. For more insight, you may also want to read Cratejoy’s Terms of Service or Privacy Statement.
            </p>
            ...
            <p className="leading-5 text-gray-400 text-sm">
                ...
                Products will be shipped via USPS Media Mail within the United States (continental, Alaska, Hawaii as well as overseas military addresses including APO, DPO, etc.) and via USPS First Class Package International to Canada. Any delivery dates provided by Company are estimates. Company reserves the right to make deliveries in installments. Company will send you an email when your order has shipped and you may review your order and shipping information on your Account. Currently, we ship to the US and Canada only. You are responsible for keeping your account and shipping information accurate and up-to-date and any address changes for a month’s package must be made by the 14th of the month by 1:00 PM Pacific time to be valid for that month’s package. If one of your packages is returned to us, we will resend the first package for free as a courtesy, but any future packages that are returned to us for an incorrect address will be invoiced to the customer for shipping (including fees due upon delivery to The Company as well as return shipping charges to The Customer.)
            </p>
            <h2 className="not-prose text-gray-200">
                SECTION 7- CANCELLATION POLICY
            </h2>
            <p className="leading-5 text-gray-400 text-sm">
                Subscriptions of any length (1-, 3-, 6-, or 12-month terms) automatically renew at the completion of the term. You may, however, choose not to renew your subscription for an additional term at anytime. Cancel by 1:00 PM Pacific time on the 14th of the designated renewal month if you do not wish to continue the subscription for an additional term. To cancel, email us at contact@iaminnnovativecoder.com with the name and/or email address of the account. If you email to cancel before 1:00 PM Pacific time on the 14th of your renewal month, you will not be charged or, if already charged will be eligible for a full refund of your renewal. If you email to cancel after 1:00 Pacific time on the 14th of the renewal month, you are ineligible for a refund and will receive the subscription for the duration of the renewal period (either 1, 3, 6, or 12 months depending on the subscription length). Gift subscriptions (1-, 3-, 6-, or 12-month terms) will expire after the original term is complete unless the gift giver has indicated at the time of purchase that he or she wishes the gift to auto-renew at the completion of the term.
            </p>
            <h2 className="not-prose text-gray-200">
            ...
            <p className="leading-5 text-gray-400 text-sm">
                ...
                Return Policy. Subscription boxes are not eligible for return.
                Exchanges. We do not accept any Product exchanges.
                Damaged Products. If the Product arrives damaged or not substantially as described on the Product information page (“Damaged Product”), Company will send replacement product if photo documentation is provided of the damaged product within 48 hours of the Product’s delivery (as determined by USPS tracking data) to contact@iaminnnovativecoder.com.
            </p>
            ...
            <p className="leading-5 text-gray-400 text-sm">
                Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy, click the “Privacy” link from the bottom of the Home Page.
            </p>
            <h2 className="not-prose text-gray-200">
            ...
            <p className="leading-5 text-gray-400 text-sm ">
                Questions about the Terms of Service should be sent to us at contact@iaminnnovativecoder.com.
            </p>
            <Footer />
        </div>
    )

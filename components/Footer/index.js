...
export default function Footer() {
    return (
        ...
        <footer className="my-20 px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100 text-white mx-auto ">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 ">
                    <a href="#" className="flex justify-center space-x-3">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full border border-gray-600">
                        ...
                        <span className="self-center text-2xl font-semibold">Hacking Unleashed</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase dark:text-coolGray-50">Social Handles</h3>
                        <ul className="space-y-1">
                            <li>
                                <Link href="https://www.instagram.com/innovative_coder" passHref={true}>Instagram</Link>
                            </li>
                            <li>
                                <a href="/">Twitter</a>
                            </li>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            <a href="#" title="Twitter" className="flex items-center p-1">
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5 fillCurrent">
            ...
            <div className="py-6 text-sm text-center">© 2022 Innovative Coder. All rights reserved.</div>
        </footer>
    )
}
